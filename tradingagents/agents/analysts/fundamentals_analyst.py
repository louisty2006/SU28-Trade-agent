...
def create_fundamentals_analyst(llm):
    def fundamentals_analyst_node(state):
        ...
        cfg = get_config()
        stmt_freq = cfg.get("fundamentals_statement_freq", "quarterly")
        ...
        base = get_analyst_system_prompt("fundamentals", cfg)
        system_message = (
            base
            + f" Prefer `{stmt_freq}` frequency when calling balance sheet, cash flow, and income statement tools."
